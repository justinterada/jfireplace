...
void setup()
{
  ...
  digitalWrite(switchPin, LOW);   // set value to LOW (off) to match stateLED=0
...
void on()
{
  ...
  digitalWrite(switchPin, HIGH);  // turn switch on
...
void off()
{
  ...
  digitalWrite(switchPin, LOW);   // turn switch off
